    ...
    <div class="m-4 flex flex-col md:flex-row bg-white rounded-xl shadow-xl w-full max-w-4xl overflow-hidden">
        ...
        <div class="w-full md:w-1/2 flex flex-col justify-center items-center p-10">
            <div class="bg-gray-50 p-8 rounded-lg shadow-lg w-full max-w-sm border">
                ...
                <form action="<?php echo $this->url("Empleado", "login"); ?>" method="POST" class="space-y-5">
                    <div class="relative">
                    ...
                    <div class="text-right">
                        <a href="<?php echo $this->url("Web", "Password"); ?>" class="text-sm text-blue-500 hover:underline">¿Olvidaste tu contraseña?</a>
                    </div>
                    ...
                    <p class="text-sm text-gray-600 text-center">
                        ...
                        <a href="<?php echo $this->url("Web", "register"); ?>" class="text-blue-500 hover:underline font-semibold">Regístrate aquí</a>
                    </p>
                </form>
            </div>
        </div>
